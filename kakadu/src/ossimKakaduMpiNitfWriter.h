...
//
//----------------------------------------------------------------------------
// $Id: ossimKakaduMpiNitfWriter.h 19904 2011-08-05 17:50:32Z dburken $
#ifndef ossimKakaduMpiNitfWriter_HEADER
#define ossimKakaduMpiNitfWriter_HEADER 1
...
class ossimKakaduMpiNitfWriter : public ossimNitfWriterBase
{
public:

   /** @brief default constructor */
   ossimKakaduMpiNitfWriter();

   /* @brief virtual destructor */
   virtual ~ossimKakaduMpiNitfWriter();
   ...
   virtual void setFileHeaderV2_1(ossimRefPtr<ossimNitfFileHeaderV2_1>, bool preferSource=true);
   virtual void setImageHeaderV2_1(ossimRefPtr<ossimNitfImageHeaderV2_1>, bool preferSource=true);
...
private:
   ...
   bool                  m_useSourceFileHeader;
   bool                  m_useSourceImageHeader;
